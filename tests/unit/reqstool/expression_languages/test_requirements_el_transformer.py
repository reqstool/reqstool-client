...
def create_tree():
    def closure(el: str):
        tree = GenericELTransformer.parse_el(el)
...
def test_comp_id_equals_urn_completion(create_tree, requirement_data):
    ...
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_001")).transform(tree) is True
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_101")).transform(tree) is False
    ...
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_999")).transform(tree) is False
...
def test_comp_id_not_equals(create_tree, requirement_data):
    ...
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_001")).transform(tree) is False
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_101")).transform(tree) is True
...
def test_comp_id_regex_equals(create_tree, requirement_data):
    ...
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:123")).transform(tree) is False
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_")).transform(tree) is False
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_1")).transform(tree) is False
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_01")).transform(tree) is True
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_101")).transform(tree) is True
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_1234")).transform(tree) is False
    assert GenericELTransformer(urn="urn", data=requirement_data("urn:REQ_123")).transform(tree) is True
...
def test_parse_el_invalid_operator_raises():
    ...
    with pytest.raises(Exception):
        GenericELTransformer.parse_el('ids > "REQ_001"')

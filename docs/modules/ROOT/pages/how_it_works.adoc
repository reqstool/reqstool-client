...
* **Java** -- https://github.com/reqstool/reqstool-java-annotations[reqstool-java-annotations] (annotations)
* **Python** -- https://github.com/reqstool/reqstool-python-decorators[reqstool-python-decorators] (decorators)
* **TypeScript** -- https://github.com/reqstool/reqstool-typescript-tags[reqstool-typescript-tags] (tags)

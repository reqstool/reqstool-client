...
| 3 | Extend OpenSpec to remaining domains (domain-by-domain, commit each) | Opus | 🟡 in progress | `data-sources` ✅ (8 reqs); todo: ingestion/parsing, imports & filtering, parse-time validation, lifecycle |
